...
<h1>Введение</h1>
Недавно у меня бьла задача по созданию рекоммендательной системы для компании <a href="https://goodgame.ru/">GoodGame.ru</a>. Подробнее об этом кейсе <a href="https://terra-university.website/goodgame">здесь</a>.<br><br>
...
А так же можно заметить что самые популярные игры расположилсь по бокам, а "нишевые" по центру, как в некотором скрытом пространстве.<br><br>
...
Внутри красного прямоугольника получилась пустая зона. Она равна той, что была на прошлом изображении. В силу большого количества игр их сложно уместить на одном экране. Тут ничего не поделаешь(
Тут мы уже можем видеть похожие игры не только по предсказаниям, но и по интересам. Это можно интерпретировать как то, что пользователи могут смотреть соседние игры и потому иметь похожие предсказания. Тут ещё лучше видно область более редких игр по середине.
<h2>Выводы</h2>
